...
<div class="p-sidebar_img">
    <img src="<?php echo $Main_img[20]; ?>" alt="サムネイル" class="c-img">
  </div>
  ...
  <div class="p-sidebar_arcive">
    <ul class="js-list">
      <li class="js-click-arcive p-sidebar_arciveSelect">月を選択して下さい<img src="<?php echo getImg('arrow_bottom.png') ?>" alt="↓" class="arrow_bottom js-arrow"></li>
