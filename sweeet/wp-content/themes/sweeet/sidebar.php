<?php
  ...
  for ($i = 20; $i <= 20; $i++) {
    ...
    $Main_img[20] =  get_option('main_view' . $i);
...
<div class="p-sidebar">
  <div class="p-sidebar_img">
    <img src="<?php echo $Main_img[20];  ?>" alt="" class="c-img">
  </div>
          ...
          <a href="<?php the_permalink() ?>" class="sidebar__link">
            ...
            <ul class="sidebar__metaItem">
              <li class="sidebar__metaList">
                <img src="<?php echo getURL('crock.png'); ?>" alt="日付" class="sidebar__icon">
              ...
              ?>
              <li class="sidebar__metaList">
                <img src="<?php echo getURL('folder.png'); ?>" alt="カテゴリー" class="sidebar__icon">
